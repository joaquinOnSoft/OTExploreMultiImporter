...
This project deprecates 3 pre-existing projects:
  ...
  * [OTExploreExcelImporter](https://github.com/joaquinOnSoft/OTExploreExcelImporter) <span style="color:red">`DEPRECATED`</span>
  * [OTExploreRedditImporter](https://github.com/joaquinOnSoft/OTExploreRedditImporter) <span style="color:red">`DEPRECATED`</span>
  * [OTExploreTwitterImporter](https://github.com/joaquinOnSoft/OTExploreTwitterImporter) <span style="color:red">`DEPRECATED`</span>